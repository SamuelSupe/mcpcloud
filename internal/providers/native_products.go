...
var nativeProductTypeOverrides = map[string]map[string]struct{}{
	"aws.compute.list_instances": {
		"AWS::EC2::Instance": {},
		"ec2:instance":       {},
	},
	"aws.compute.list_disks": {
		"AWS::EC2::Volume": {},
		"ec2:volume":       {},
	},
	...
	"aws.kubernetes.list_resources": {
		"AWS::EKS::Cluster":   {},
		"AWS::EKS::Nodegroup": {},
		"eks:cluster":         {},
		"eks:nodegroup":       {},
	},
	"aws.monitoring.list_alarms": {
		"AWS::CloudWatch::Alarm": {},
		"cloudwatch:alarm":       {},
	},
	"aws.logging.list_resources": {
		"AWS::Logs::LogGroup": {},
		"logs:log-group":      {},
	},
